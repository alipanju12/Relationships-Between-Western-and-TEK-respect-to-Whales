...
// a function to unlock the next card
        ...
        const cards = ref([
...

            {
                showDetails: false,
                unlocked: true,
                unlockQuestion: "Is the perspective of preservationism an Indigenous Perspective?",
                unlockAnswer: false,
                ...
                // Image taken from https://www.knkx.org/environment/2019-11-13/20-years-later-atmosphere-has-changed-around-makah-whale-hunt
                issue: "Under the 1855 Treaty of Neah Bay, the Makah retained the right to hunt whales but paused for 70 years to allow gray whale populations to recover from commercial over-harvesting. In the 1990s, the Makah sought to resume their harvest. This sparked a massive clash with Western environmentalists and animal rights groups, who argued that whales are too intelligent to hunt and that the use of modern technology (like motorized boats) invalidated the 'traditional' nature of the hunt. This unfortunately led to significant public and media-driven racism.",
                indigenousPerspective: "For the Makah, whaling isn't just a resource extraction; it is a spiritual practice involving ritual preparation, ceremonies, and the 'potlatch' distribution of meat that binds the community together. Traditional Ecological Knowledge views humans not as 'external protectors' of a glass-cased wilderness, but as active participants within the ecosystem. The hunt is a manifestation of a deep, reciprocal relationship between the people and the sea, rather than a destructive commercial act.",
                westernPerspective: "The core of the controversy lies in the friction between Western 'preservationist' science—which views humans as a threat to nature—and TEK, which views human participation as essential to the ecosystem's balance.",
                x: "35%",
                y: "20%",
                z: "4"
